...
/*
Реализация проектного задания, для поступления в школу мобильной разработки Яндекса,
на основе библиотеки - "Quotes API for Yahoo Finance-3.15.0"
https://financequotes-api.com/ ,
c кешированием избранного и его сохранением после закрытия приложения.
...
изменение компоновки элементов активити и небольшая доработка кеша.
 */
